...
urlpatterns = [
    ...
    path('type/group/group_new_text/<int:group_id>', views.group_new_text, name='group_new_text'),
    path('type/group/group_add_text/<int:group_id>', views.group_add_text, name='group_add_text'),
